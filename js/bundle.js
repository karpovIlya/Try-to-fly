...
var Game = /*#__PURE__*/function () {
  function Game(inputsSelector, heroSelector) {
    var _this = this;
    _classCallCheck(this, Game);
    this._inputs = document.querySelectorAll(inputsSelector);
    this._hero = document.querySelector(heroSelector);
    for (var _len = arguments.length, requiredOtions = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
      requiredOtions[_key - 2] = arguments[_key];
    }
    this._requiredOtions = requiredOtions;
    this._inputs.forEach(function (input) {
      input.addEventListener('input', function () {
        _this.useEnteredStyle();
        _this.checkCode();
      });
    });
  }
  _createClass(Game, [{
    ...
    value: function checkCode() {
      ...
      for (var i = 0; i < this._inputs.length; i++) {
        for (var j = 0; j < this._requiredOtions.length; j++) {
    ...
    key: "returnInputValueInText",
    value: function returnInputValueInText() {
      var result = '';
      this._inputs.forEach(function (input) {
        result += input.value + '\n';
      });
    ...
    key: "useEnteredStyle",
    value: function useEnteredStyle() {
      console.log();
      this._hero.style.cssText = "\n      ".concat(this.returnInputValueInText(), ";\n    ");
    }
  }]);
  return Game;
}();
